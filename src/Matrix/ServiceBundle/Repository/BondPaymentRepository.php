...
class BondPaymentRepository extends EntityRepository{
    ...
    public function findMaxVersion(){
        ...
        $query = $this->getEntityManager()
            ->createNativeQuery('SELECT MAX(version)+1 AS res FROM bond_payment', $rsm);
    ...
    public function findByVersion($version, Users $user){
        ...
        $qb->select('o')
            ->from('Matrix\ServiceBundle\Entity\BondPayment' , "o")
