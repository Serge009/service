...
class DispatchItemRepository extends EntityRepository {
    ...
    public function findMaxVersion(){
        ...
        $query = $this->getEntityManager()
            ->createNativeQuery('SELECT MAX(version)+1 AS res FROM dispatch_item', $rsm);
    ...
    public function findByVersion($version, Users $user){
        ...
        $qb->select('oi')
            ->from('Matrix\ServiceBundle\Entity\DispatchItem' , "oi")
            ->innerJoin('oi.dispatch', "o")
